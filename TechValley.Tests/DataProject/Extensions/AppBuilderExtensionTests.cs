...
using TechValley.Data.Extensions;
using TechValley.Data.Interfaces;
using TechValley.Tests.Stubs;
using TechValley.Core.Extensions;
using TechValley.Data.SqlServer;
using TechValley.Tests.Factories;

namespace TechValley.Tests.DataProject.Extensions
{
    [TestFixture]
    public class AppBuilderExtensionsTests
    {
        ...
        protected AppBuilder GetAppBuilder(IConfigurationBuilder builder)
        {
            ...
            {
                appBuilder.AddAutomapperProfilesFromAssemblies("TechValley");
