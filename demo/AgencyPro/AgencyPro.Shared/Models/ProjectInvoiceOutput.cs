...
public class ProjectInvoiceOutput : InvoiceInput, IProjectInvoice, IOrganizationPersonTarget
{
    ...
    [JsonIgnore] public override Guid[] ContractIds { get; set; }

    [JsonIgnore] public override bool IncludeAllContracts { get; set; }

    public string ProviderOrganizationName => ProjectManagerOrganizationName;
    public Guid ProviderOrganizationId => ProjectManagerOrganizationId;
    public string ProviderOrganizationImageUrl => ProjectManagerOrganizationImageUrl;

    [JsonIgnore] public virtual Guid TargetOrganizationId { get; }
