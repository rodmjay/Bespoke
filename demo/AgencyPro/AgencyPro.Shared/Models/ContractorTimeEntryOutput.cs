...
public class ContractorTimeEntryOutput : TimeEntryOutput
{
    ...
    [JsonIgnore] public override decimal TotalMarketingAgencyStream { get; set; }

    [JsonIgnore] public override decimal TotalRecruitingAgencyStream { get; set; }

    [JsonIgnore] public override decimal TotalRecruitingStream { get; set; }

    [JsonIgnore] public override decimal TotalMarketingStream { get; set; }
}