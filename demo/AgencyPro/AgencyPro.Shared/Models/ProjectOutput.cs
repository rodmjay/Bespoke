...
public abstract class ProjectOutput : ProjectInput, IProject, IOrganizationPersonTarget
{
    ...
    [JsonIgnore] public virtual decimal TotalHoursApproved { get; set; }
    ...
    public virtual decimal WeightedRecruiterAverage
    {
        get
        {
            if (MaxBillableHours > 0) return MaxRecruiterStream / MaxBillableHours;
    ...
    public virtual decimal WeightedMarketerAverage
    {
        get
        {
            if (MaxBillableHours > 0) return MaxMarketerStream / MaxBillableHours;
    ...
    public virtual decimal WeightedProjectManagerAverage
    {
        get
        {
            if (MaxBillableHours > 0) return MaxProjectManagerStream / MaxBillableHours;
    ...
    public virtual decimal WeightedAccountManagerAverage
    {
        get
        {
            if (MaxBillableHours > 0) return MaxAccountManagerStream / MaxBillableHours;
    ...
    public virtual decimal WeightedAgencyAverage
    {
        get
        {
            if (MaxBillableHours > 0) return MaxAgencyStream / MaxBillableHours;
    ...
    public virtual decimal WeightedRecruitingAgencyAverage
    {
        get
        {
            if (MaxBillableHours > 0) return MaxRecruitingAgencyStream / MaxBillableHours;
    ...
    public virtual decimal WeightedMarketingAgencyAverage
    {
        get
        {
            if (MaxBillableHours > 0) return MaxMarketingAgencyStream / MaxBillableHours;
    ...
    public virtual decimal WeightedSystemAverage
    {
        get
        {
            if (MaxBillableHours > 0) return MaxSystemStream / MaxBillableHours;

            return 0;
        }
    }

    public virtual decimal CustomerAverageRate =>
        WeightedSystemAverage + WeightedAgencyAverage + WeightedProjectManagerAverage +
    ...
    public virtual decimal WeightedContractorAverage
    {
        get
        {
            if (MaxBillableHours > 0) return MaxContractorStream / MaxBillableHours;
            return 0;
        }
    }
