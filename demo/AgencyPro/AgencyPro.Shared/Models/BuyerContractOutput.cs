namespace AgencyPro.Shared.Models
{
    public abstract class BuyerContractOutput : ContractOutput
    {
        ...
        [JsonIgnore] public sealed override string RecruiterName { get; set; } = null!;
        [JsonIgnore] public sealed override string RecruiterImageUrl { get; set; } = null!;
        [JsonIgnore] public sealed override string RecruiterOrganizationName { get; set; } = null!;
        [JsonIgnore] public sealed override string RecruiterOrganizationImageUrl { get; set; } = null!;
