...
public abstract class ContractOutput : ContractInput, IContract, IOrganizationPersonTarget
{
    ...
    public virtual string ContractorImageUrl { get; set; } = null!;
    ...
    [JsonProperty("number")] public virtual int ProviderNumber { get; set; }

    [JsonProperty("number")] public virtual int BuyerNumber { get; set; }

    [JsonProperty("number")] public virtual int MarketingNumber { get; set; }

    [JsonProperty("number")] public virtual int RecruitingNumber { get; set; }
