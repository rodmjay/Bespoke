...
public class ChargeOutput : IStripeCharge
{
    ...
    [JsonIgnore] public string InvoiceId { get; set; }
    ...
    [JsonIgnore] public string BalanceTransactionId { get; set; }

    public bool? Captured { get; set; }

    [JsonIgnore] public string CustomerId { get; set; }

    [JsonIgnore] public string OnBehalfOfId { get; set; }

    public bool Refunded { get; set; }

    [JsonIgnore] public string StatementDescriptorSuffix { get; set; }

    public string StatementDescriptor { get; set; }
    [JsonIgnore] public string PaymentIntentId { get; set; }
    public string OutcomeType { get; set; }

    [JsonIgnore] public string OutcomeSellerMessage { get; set; }
