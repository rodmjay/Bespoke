...
namespace AgencyPro.Services.Organizations.Implementation
{
    public class OrganizationService : BaseService<Organization>, IOrganizationService
    {
        ...
        public async Task<OneOf<OrganizationDto, Result>> CreateOrganizationAsync(UserInfo user, OrganizationOptions input, CancellationToken ct = default)
        {
        ...
        public async Task<T> GetOrganization<T>(UserInfo user, Guid id, CancellationToken ct = default) where T : IOrganization
        {
