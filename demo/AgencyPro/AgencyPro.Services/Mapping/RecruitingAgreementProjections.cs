...
public class RecruitingAgreementProjections : Profile
{
    public RecruitingAgreementProjections()
    {
        CreateMap<RecruitingAgreement, RecruitingAgreementOutput>()
            ...
            .ForMember(x => x.RecruitingOrganizationName,
                opt => opt.MapFrom(x => x.RecruitingOrganization.Organization.Name))
            .ForMember(x => x.RecruiterOrganizationImageUrl,
                opt => opt.MapFrom(x => x.RecruitingOrganization.Organization.ImageUrl))
