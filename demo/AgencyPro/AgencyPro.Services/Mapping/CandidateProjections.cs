using AgencyPro.Shared.Models.Candidates;
using AutoMapper;

namespace AgencyPro.Services.Mapping;

public class CandidateProjections : Profile
{
    public CandidateProjections()
    {
        CreateMap<Candidate, CandidateOutput>()
            ...
            .ForMember(x => x.ProviderOrganizationImageUrl,
                opt => opt.MapFrom(x => x.ProviderOrganization.Organization.ImageUrl))
            .ForMember(x => x.ProviderOrganizationName,
                opt => opt.MapFrom(x => x.ProviderOrganization.Organization.Name))
            .ForMember(x => x.RecruitingOrganizationOwnerId,
                opt => opt.MapFrom(x => x.RecruiterOrganization.CustomerId))
            .ForMember(x => x.ProviderOrganizationOwnerId,
                opt => opt.MapFrom(x => x.ProviderOrganization.Organization.CustomerId))
            ...
            .ForMember(x => x.RecruiterName,
                opt => opt.MapFrom(x => x.Recruiter.Person.FirstName))
            ...
            .ForMember(x => x.ProjectManagerName,
                opt => opt.MapFrom(x => x.ProjectManager.Person.FirstName))
