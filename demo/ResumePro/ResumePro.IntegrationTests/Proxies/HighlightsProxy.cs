...
public sealed class HighlightsProxy : BaseProxy, IHighlightsController
{
    ...
    public Task<ActionResult<HighlightDto>> CreateHighlight(int personId, int companyId, int positionId,
        HighlightOptions options)
    {
        throw new NotImplementedException();
    }

    public Task<ActionResult<HighlightDto>> UpdateHighlight(int personId, int companyId, int positionId,
