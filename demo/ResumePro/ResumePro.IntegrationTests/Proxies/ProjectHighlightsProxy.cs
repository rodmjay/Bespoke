...
public sealed class ProjectHighlightsProxy : BaseProxy, IProjectHighlightsController
{
    ...
    public Task<ActionResult<HighlightDto>> CreateHighlight(int personId, int companyId, int positionId, int projectId,
        HighlightOptions options)
    {
        throw new NotImplementedException();
    }

    public Task<ActionResult<HighlightDto>> UpdateHighlight(int personId, int companyId, int positionId, int projectId,
        int highlightId,
        HighlightOptions options)
    {
        throw new NotImplementedException();
